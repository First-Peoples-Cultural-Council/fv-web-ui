        ...
        {selectedMenu === null ? (
          <ul className="grid grid-rows-3 divide-y-2 divide-gray-200">
            ...
            <li key="Register_id" className="py-5 px-5 space-y-6 w-full flex items-center">
              <a
                href="/register"
                className="ml-8 whitespace-nowrap inline-flex items-center justify-center py-2 px-4 border border-transparent rounded-3xl  shadow-sm text-base font-medium text-white bg-secondary hover:bg-secondary-dark"
              >
                Register
              </a>
            </li>
