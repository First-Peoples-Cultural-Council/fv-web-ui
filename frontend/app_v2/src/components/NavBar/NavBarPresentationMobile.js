    ...
    return items.map((item) => (
      <li key={`${item.title}_id`}>
        <button
          ...
          className="w-full m-3 p-1 text-fv-primary flex items-center hover:bg-gray-50 focus:outline-none focus:ring-0"
        >
          {useIcon(item.title, 'fill-current h-12 w-8')}
          <p className="ml-3 text-fv-primary font-medium hover:text-fv-primary-dark">{item.title}</p>
          ...
          <ul className="grid grid-rows-3 divide-y-2 divide-gray-200">
            ...
            <li key="SignIn_id">
              <button
                ...
                type="button"
                className="w-full m-3 p-1 text-fv-primary flex items-center hover:bg-gray-50 focus:outline-none"
              >
                {useIcon('Login', 'fill-current h-12 w-8')}
                <p className="ml-3 text-fv-primary font-medium hover:text-fv-primary-dark">Sign in</p>
              </button>
            </li>
            <li key="Register_id" className="py-5 px-5 space-y-6 w-full flex items-center">
              <a
                href="/register?requestedUrl=/register"
                className="ml-8 whitespace-nowrap inline-flex items-center justify-center py-2 px-4 border border-transparent rounded-3xl  shadow-sm text-base font-medium text-white bg-fv-secondary hover:bg-fv-secondary-dark"
              >
                Register
              </a>
            </li>
          ...
          <ul className="grid grid-rows-3 divide-y-2 divide-gray-200">
            ...
            <li key="BackButton_id">
              ...
              >
                ...
                <p className="ml-3 text-fv-primary font-medium hover:text-fv-primary-dark">Back</p>
              </button>
            </li>
          </ul>
        )}
