...
function AboutPresentation({ title, text, image, link }) {
  const renderLink = (l) => (
    <a className="bg-fv-secondary text-white px-4 py-4 rounded-xl font-bold text-l" href={l.href}>
      {l.title}
    </a>
  )
    ...
    <section className="bg-white" data-testid="AboutPresentation">
      <div className="relative overflow-hidden py-4">
        <div className="z-10 md:w-2/4 md:my-32 md:-right-32 px-6 py-6 bg-white relative ">
          <h2 className="mb-4 lg:mb-10 lg:text-4xl text-fv-secondary font-bold text-3xl">
