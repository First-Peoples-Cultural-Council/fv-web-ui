  ...
  return (
    <section className="bg-white py-12 mx-10">
      <div className="relative mx-10">
        <h2 className="mb-12 relative z-10 text-center text-4xl text-primary font-bold uppercase sm:text-5xl">
        ...
        <div className="grid grid-cols-6">
          <form ref={contactFormRef} className="col-span-6 sm:col-span-3" onSubmit={handleSubmit}>
            <div className="grid grid-cols-7 gap-3">
              ...
              <label className="col-span-2 uppercase tracking-wide text-primary text-xl font-bold mb-2" htmlFor="Name">
                Name:
              </label>
              <input
                ...
                type="text"
              />
              <label className="col-span-2 uppercase tracking-wide text-primary text-xl font-bold mb-2" htmlFor="Email">
                E-mail:
              </label>
              <input
              ...
              <div className="col-span-7">
                <label className="block uppercase tracking-wide text-primary text-xl font-bold mb-2" htmlFor="Message">
                  Message:
                </label>
                <textarea
          ...
          <div className="col-span-6 sm:col-start-5 sm:col-span-2 mt-8 sm:mt-0">
            <h3 className="block uppercase tracking-wide text-primary text-xl font-bold mb-2">Address</h3>
            <div className="block mb-6" dangerouslySetInnerHTML={{ __html: contactText }} />
            <h3 className="block uppercase tracking-wide text-primary text-xl font-bold mb-2">Follow us</h3>
