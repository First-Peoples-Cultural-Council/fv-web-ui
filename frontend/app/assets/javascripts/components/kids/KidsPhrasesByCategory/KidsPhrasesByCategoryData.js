 ...
 *
 * @prop {object} props
 * @prop {function} props.children Render prop technique. Assumes children will be a function, eg: children(output)
 *
 * @returns {object} output = {computeEntities, items, resultsCount}
 * @returns {arrayImmutable} output.computeEntities used with PromiseWrapper
 * @returns {array} output.items Phrase data
 * @returns {number} output.resultsCount Phrase count
 */
