...
if [ "$2" != "-skip-clone" ]; then
  ...
  if [ -d "$DIRECTORY/app/QA/temp/fv-utils-temp" ]; then
    echo "Removing old fv-utils"
    rm -rf $DIRECTORY/app/QA/temp/fv-utils-temp
  fi
  if [ -d "$DIRECTORY/app/QA/temp/fv-batch-import-temp" ]; then
    echo "Removing old fv-batch-import"
    rm -rf $DIRECTORY/app/QA/temp/fv-batch-import-temp
  fi

  mkdir temp

  git clone https://github.com/First-Peoples-Cultural-Council/fv-batch-import.git ./app/QA/temp/fv-batch-import-temp
  if [[ "$?" -ne 0 ]]; then
    echo
  ...
  git clone https://github.com/First-Peoples-Cultural-Council/fv-utils.git ./app/QA/temp/fv-utils-temp
  if [[ "$?" -ne 0 ]]; then
    echo
  ...
  echo
  cd $DIRECTORY/app/QA/temp/fv-utils-temp
  mvn clean install
  ...
  echo
  cd $DIRECTORY/app/QA/temp/fv-batch-import-temp
  mvn clean install
  # Check that the return code is zero
  if [[ "$?" -ne 0 ]]; then
    echo
...
# ----- TEST LANGUAGE ONE ------
cd $DIRECTORY/app/QA/temp/fv-utils-temp/target/
...
cd $DIRECTORY/app/QA/temp/fv-batch-import-temp/target
java -jar fv-batch-import-*.jar -url "$TARGET/nuxeo" -username $CYPRESS_FV_USERNAME -password $CYPRESS_FV_PASSWORD -domain FV -csv-file $DIRECTORY/app/QA/scripts/files/testLangTwoWord.csv -data-path $DIRECTORY/app/QA/scripts/files/testLangTwoMedia/ -dialect-id fillerID -language-path Test/Test/TestLanguageTwo
if [[ "$?" -ne 0 ]]; then
...
cd $DIRECTORY/app/QA/scripts/batch_jarfiles/
java -jar fv-batch-import-phrases.jar -url "$TARGET/nuxeo" -username $CYPRESS_FV_USERNAME -password $CYPRESS_FV_PASSWORD -domain FV -csv-file $DIRECTORY/app/QA/scripts/files/testLangTwoPhrase.csv -data-path $DIRECTORY/app/QA/scripts/files/testLangTwoMedia/ -dialect-id fillerID -language-path Test/Test/TestLanguageTwo
if [[ "$?" -ne 0 ]]; then
...
# Import Word using fv-batch-import
cd $DIRECTORY/app/QA/temp/fv-batch-import-temp/target
java -jar fv-batch-import-*.jar -url "$TARGET/nuxeo" -username $CYPRESS_FV_USERNAME -password $CYPRESS_FV_PASSWORD -domain FV -csv-file $DIRECTORY/app/QA/scripts/files/testLangFiveWord.csv -data-path $DIRECTORY/app/QA/scripts/files/testLangTwoMedia/ -dialect-id fillerID -language-path Test/Test/TestLanguageFive
if [[ "$?" -ne 0 ]]; then
...
# Import Phrase using fv-batch-import
cd $DIRECTORY/app/QA/scripts/batch_jarfiles/
java -jar fv-batch-import-phrases.jar -url "$TARGET/nuxeo" -username $CYPRESS_FV_USERNAME -password $CYPRESS_FV_PASSWORD -domain FV -csv-file $DIRECTORY/app/QA/scripts/files/testLangFivePhrase.csv -data-path $DIRECTORY/app/QA/scripts/files/testLangTwoMedia/ -dialect-id fillerID -language-path Test/Test/TestLanguageFive
if [[ "$?" -ne 0 ]]; then
...
cd $DIRECTORY/app/QA/temp/fv-batch-import-temp/target
java -jar fv-batch-import-*.jar -url "$TARGET/nuxeo" -username $CYPRESS_FV_USERNAME -password $CYPRESS_FV_PASSWORD -domain FV -csv-file $DIRECTORY/app/QA/scripts/files/testLangSixWord.csv -data-path $DIRECTORY/app/QA/scripts/files/testLangTwoMedia/ -dialect-id fillerID -language-path Test/Test/TestLanguageSix
if [[ "$?" -ne 0 ]]; then
...
cd $DIRECTORY/app/QA/scripts/batch_jarfiles/
java -jar fv-batch-import-phrases.jar -url "$TARGET/nuxeo" -username $CYPRESS_FV_USERNAME -password $CYPRESS_FV_PASSWORD -domain FV -csv-file $DIRECTORY/app/QA/scripts/files/testLangSixPhrase.csv -data-path $DIRECTORY/app/QA/scripts/files/testLangTwoMedia/ -dialect-id fillerID -language-path Test/Test/TestLanguageSix
if [[ "$?" -ne 0 ]]; then
...
cd $DIRECTORY/app/QA/scripts/batch_jarfiles/
java -jar fv-batch-import-alphabet.jar -url "$TARGET/nuxeo" -username $CYPRESS_FV_USERNAME -password $CYPRESS_FV_PASSWORD -domain FV -csv-file $DIRECTORY/app/QA/scripts/files/alphabet.csv -data-path $DIRECTORY/app/QA/scripts/files/testLangTwoMedia/ -dialect-id fillerID -language-path Test/Test/TestLanguageSix
if [[ "$?" -ne 0 ]]; then
...
# Import Alphabet using fv-batch-import
cd $DIRECTORY/app/QA/scripts/batch_jarfiles/
java -jar fv-batch-import-alphabet.jar -url "$TARGET/nuxeo" -username $CYPRESS_FV_USERNAME -password $CYPRESS_FV_PASSWORD -domain FV -csv-file $DIRECTORY/app/QA/scripts/files/testLangSevenAlphabet.csv -data-path $DIRECTORY/app/QA/scripts/files/testLangTwoMedia/ -dialect-id fillerID -language-path Test/Test/TestLanguageSeven
if [[ "$?" -ne 0 ]]; then
...
# Import Words using fv-batch-import
cd $DIRECTORY/app/QA/temp/fv-batch-import-temp/target
java -jar fv-batch-import-*.jar -url "$TARGET/nuxeo" -username $CYPRESS_FV_USERNAME -password $CYPRESS_FV_PASSWORD -domain FV -csv-file $DIRECTORY/app/QA/scripts/files/testLangSevenWord.csv -data-path $DIRECTORY/app/QA/scripts/files/testLangTwoMedia/ -dialect-id fillerID -language-path Test/Test/TestLanguageSeven
if [[ "$?" -ne 0 ]]; then
...
# Import Words using fv-batch-import
cd $DIRECTORY/app/QA/temp/fv-batch-import-temp/target
java -jar fv-batch-import-*.jar -url "$TARGET/nuxeo" -username $CYPRESS_FV_USERNAME -password $CYPRESS_FV_PASSWORD -domain FV -csv-file $DIRECTORY/app/QA/scripts/files/testLangEightWord.csv -data-path $DIRECTORY/app/QA/scripts/files/testLangTwoMedia/ -dialect-id fillerID -language-path Test/Test/TestLanguageEight
if [[ "$?" -ne 0 ]]; then
...
# Import Alphabet using fv-batch-import
cd $DIRECTORY/app/QA/scripts/batch_jarfiles/
java -jar fv-batch-import-alphabet.jar -url "$TARGET/nuxeo" -username $CYPRESS_FV_USERNAME -password $CYPRESS_FV_PASSWORD -domain FV -csv-file $DIRECTORY/app/QA/scripts/files/alphabet.csv -data-path $DIRECTORY/app/QA/scripts/files/testLangTwoMedia/ -dialect-id fillerID -language-path Test/Test/TestLanguageEight
if [[ "$?" -ne 0 ]]; then
...
cd $DIRECTORY/app/QA/scripts/files/
